...
datasheet = datasheet_path_5m_list

profit_loss_ratio_list = [];
# contract_index = random.randint(0,100)
...
raw_eth_price_data = pd.read_csv("/Users/han/Crypto/QuantAnalysis/binance_api/Future_Data/1INCHUSDT/1INCHUSDT_1h.csv", index_col = 0);
