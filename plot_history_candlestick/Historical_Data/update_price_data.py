...
contract_list = os.listdir("./plot_history_candlestick/Historical_Data/Data")[1:] #显示所有合约
# print(contract_list)
for i in range (0,len(contract_list)):
    contract = contract_list[i] #选择一个合约
    contract_path = "./plot_history_candlestick/Historical_Data/Data/" + contract_list[i] #选择合约的路径
